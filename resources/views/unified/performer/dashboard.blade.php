...
<head>
    <meta charset="UTF-8">
    <title>Performer Dashboard — seolinkplace</title>
...
<nav class="bg-white border-b border-gray-200 px-4 py-3 flex justify-between items-center">
    <div class="flex items-center gap-6">
        ...
        <span class="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded-full">Performer</span>
    </div>
...
<div class="max-w-4xl mx-auto py-10 px-4">
    <h1 class="text-xl font-bold text-gray-900">Кабінет Performer</h1>
