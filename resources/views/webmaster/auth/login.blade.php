...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <div class="w-full max-w-6xl">
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-1 text-sm">Кабінет вебмастера</p>
        </div>
        <div class="bg-white rounded-2xl border border-gray-200 p-8">
            ...
            @if(session('prefill_email'))
                <div class="mb-4 p-3 bg-amber-50 border border-amber-200 text-amber-700 rounded-lg text-sm">
                    Переключення з кабінету клієнта. Введіть пароль для вебмастера.
                </div>
            @endif
            ...
            <p class="mt-6 text-center text-sm text-gray-500">
                Немає акаунту? <a href="{{ route('webmaster.register') }}" class="text-gray-900 font-medium hover:underline">Зареєструватись</a>
            </p>
        </div>
    </div>
</body>
